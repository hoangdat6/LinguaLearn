  ...
  const fetchUserDetails = async () => {
    try {
      ...
      const userData: User = {
        ...
        completedLessons: response.data.completed_lessons ?? 0,
        totalLessons: response.data.total_lessons ?? 0,
        completedTopics: response.data.completed_topics ?? 0,
        totalTopics: response.data.total_topics ?? 0,
        learningTime: response.data.learning_time ?? "",
        subscription: response.data.subscription ?? "",
        subscriptionExpiry: response.data.subscription_expiry ?? "",
